...
public class CryptoProvider {
    ...
    public interface BcFunc<T, R> {
        R apply(T t) throws NoSuchAlgorithmException, CertificateException, InvalidKeyException,
                OperatorCreationException, IOException, XMLSecurityException, SignatureException,
            ...
            while (itr.hasNext()) {
                ...
                try {
                    return fn.apply(provider);
                         ...
                         OperatorCreationException | IOException | XMLSecurityException |
