    ...
    implements Serializable
{
    ...
    @XmlElements({
        ...
        @XmlElement(name = "EvidenceRecord", type = XmlEvidenceRecord.class),
        @XmlElement(name = "Certificate", type = XmlCertificate.class)
    })
    protected List<Serializable> signatureOrTimestampOrEvidenceRecord;
     ...
     * This is why there is not a <CODE>set</CODE> method for the signatureOrTimestampOrEvidenceRecord property.
     * 
     * <p>
    ...
    public List<Serializable> getSignatureOrTimestampOrEvidenceRecord() {
        if (signatureOrTimestampOrEvidenceRecord == null) {
            signatureOrTimestampOrEvidenceRecord = new ArrayList<Serializable>();
        }
