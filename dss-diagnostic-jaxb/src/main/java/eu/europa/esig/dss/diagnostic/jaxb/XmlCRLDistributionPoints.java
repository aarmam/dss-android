...
/**
 * <p>Java class for CRLDistributionPoints complex type.
 * 
...
@XmlType(name = "CRLDistributionPoints", propOrder = {
    "crlUrl"
})
    ...
    implements Serializable
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the crlUrl property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCrlUrl().add(newItem);
     * </pre>
     * 
     * 
     * <p>
