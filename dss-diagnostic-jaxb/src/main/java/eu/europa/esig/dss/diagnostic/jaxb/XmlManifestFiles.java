...
public class XmlManifestFiles
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "ManifestFile")
    protected List<XmlManifestFile> manifestFile;
     ...
     * {@link XmlManifestFile }
     * 
     * 
     */
    public List<XmlManifestFile> getManifestFile() {
        if (manifestFile == null) {
            manifestFile = new ArrayList<XmlManifestFile>();
        }
