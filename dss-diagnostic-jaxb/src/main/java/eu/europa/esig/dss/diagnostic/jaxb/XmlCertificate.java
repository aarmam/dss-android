    ...
    implements Serializable
{
    ...
    @XmlElementWrapper(name = "TrustServiceProviders")
    @XmlElement(name = "TrustServiceProvider", namespace = "http://dss.esig.europa.eu/validation/diagnostic")
    protected List<XmlTrustServiceProvider> trustServiceProviders;
    ...
    public List<XmlTrustServiceProvider> getTrustServiceProviders() {
        if (trustServiceProviders == null) {
            trustServiceProviders = new ArrayList<XmlTrustServiceProvider>();
        }
        return trustServiceProviders;
    }

    public void setTrustServiceProviders(List<XmlTrustServiceProvider> trustServiceProviders) {
