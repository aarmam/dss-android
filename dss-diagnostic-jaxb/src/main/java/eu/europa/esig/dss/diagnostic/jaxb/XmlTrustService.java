...
/**
 * <p>Java class for TrustService complex type.
 * 
...
@XmlType(name = "TrustService", propOrder = {
    "serviceNames",
    "serviceType",
    "status",
    "startDate",
...
public class XmlTrustService implements Serializable
{

    private static final long serialVersionUID = 1L;
    @XmlElementWrapper(name = "ServiceNames")
    ...
    public List<XmlQualifier> getCapturedQualifiers() {
        if (capturedQualifiers == null) {
            capturedQualifiers = new ArrayList<XmlQualifier>();
        }
