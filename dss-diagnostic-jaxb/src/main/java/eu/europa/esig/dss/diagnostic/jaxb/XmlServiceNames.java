...
public class XmlServiceNames
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "ServiceName")
    protected List<XmlLangAndValue> serviceName;
     ...
     * 
     */
    public List<XmlLangAndValue> getServiceName() {
        if (serviceName == null) {
            serviceName = new ArrayList<XmlLangAndValue>();
        }
