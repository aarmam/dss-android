...
public class XmlTrustedLists
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "TrustedList")
    protected List<XmlTrustedList> trustedList;
     ...
     * 
     */
    public List<XmlTrustedList> getTrustedList() {
        if (trustedList == null) {
            trustedList = new ArrayList<XmlTrustedList>();
        }
