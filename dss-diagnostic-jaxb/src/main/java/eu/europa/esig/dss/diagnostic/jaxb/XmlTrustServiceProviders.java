...
public class XmlTrustServiceProviders
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "TrustServiceProvider")
    protected List<XmlTrustServiceProvider> trustServiceProvider;
     ...
     * {@link XmlTrustServiceProvider }
     * 
     * 
     */
    public List<XmlTrustServiceProvider> getTrustServiceProvider() {
        if (trustServiceProvider == null) {
            trustServiceProvider = new ArrayList<XmlTrustServiceProvider>();
        }
